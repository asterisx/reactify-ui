...
describe("HorizontalCard Component", () => {
  ...
  it("should have a shadow by default", () => {
    const shallowWrapper = shallow(<HorizontalCard />);
    expect(shallowWrapper.hasClass('reactify-horizontal-card--shadowed')).to.be.true;
  });
  ...
  describe("props", () => {
    it("should accept not have a shadow when shadowed is false", () => {
      const shallowWrapper = shallow(<HorizontalCard shadowed={false} />);
      expect(shallowWrapper.hasClass('reactify-horizontal-card--shadowed')).to.be.false;
    });
